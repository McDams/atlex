...
final class Security
{
    ...
    public static function applyHeaders(): void
    {
        ...
        $csp = implode('; ', [
            ...
            "script-src 'self' 'nonce-$nonce' https://cdn.tiny.cloud https://www.paypal.com",
            "connect-src 'self' https://cdn.tiny.cloud https://www.paypal.com",
            "frame-src https://www.youtube-nocookie.com https://www.youtube.com https://www.paypal.com https://www.sandbox.paypal.com",
            "object-src 'none'",
            "base-uri 'self'",
